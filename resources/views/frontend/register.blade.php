...
<div class="Container ">
    ...
    <div class="card mt-5" style="background-color: #fff !important; border:solid 0px !important;">
        <div class="upper">
            ...
            <form id="formL" method="post" action="{{route('registerPost')}}">
                @if ($errors->any())
                ...
                <div class="form-element">
                    <span id="input-header">Nom*</span>
                    <input type="text" id="order_id" name="nom"
                                                            placeholder="NOUVIVI">
                </div>
                <div class="form-element">
                    <span id="input-header">Prénom*</span>
                    <input type="text" id="order_id" name="prenom"
                                                            placeholder="Doriane">
                </div>
                <div class="form-element">
                    <span id="input-header">Adresse*</span>
                    <input type="text" id="order_id" name="adresse"
                                                            placeholder="Calavi">
                </div>
                <div class="form-element">
                    <span id="input-header">E-mail*</span>
                    <input type="email" id="order_id" name="mail"
                    ...
                    <div class="row invalid">
                        <div class="col-11">
                            <h6 class="text-secondary mb-3 text-center">
                                <p class="mb-0">Déjà un compte?</p><a href="{{route('login')}}" class="text-info">Connectez-vous</a>
                ...
                <div class="lower">
                    <button class="btn btn-warning" type="submit" id="loader">S'inscrire</button>
                </div>
                ...
                <div class="col-md-4">
                    <div class="useful-links">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <ul>
                                    <li><a href="{{asset('frontend/pages/inde.html')}}"><i class="fa fa-stop"></i>Home</a></li>
                                    <li><a href="{{asset('frontend/pages/about.html')}}"><i class="fa fa-stop"></i>About</a></li>
                                    <li><a href="{{asset('frontend/pages/team.html')}}"><i class="fa fa-stop"></i>Team</a></li>
                                    <li><a href="{{asset('frontend/pages/contact.html')}}"><i class="fa fa-stop"></i>Contact Us</a></li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul>
                                    <li><a href="{{asset('frontend/pages/faq.html')}}"><i class="fa fa-stop"></i>FAQ</a></li>
                                    <li><a href="{{asset('frontend/pages/testimonials.html')}}"><i class="fa fa-stop"></i>Testimonials</a></li>
                                    <li><a href="{{asset('frontend/pages/blog.html')}}"><i class="fa fa-stop"></i>Blog</a></li>
                                    <li><a href="{{asset('frontend/pages/terms.html')}}"><i class="fa fa-stop"></i>Terms</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
